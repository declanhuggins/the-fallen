package com.dhugs.NoteBlockAPI.model;
	...
	private SoundEvent getSound(String name) {
		switch(name) {
			case "NOTE_PIANO", "BLOCK_NOTE_HARP", "BLOCK_NOTE_BLOCK_HARP" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_HARP.value());
			}
			case "NOTE_BASS", "BLOCK_NOTE_BASS", "BLOCK_NOTE_BLOCK_BASS" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_BASS.value());
			}
			case "NOTE_BASS_DRUM", "BLOCK_NOTE_BASEDRUM", "BLOCK_NOTE_BLOCK_BASEDRUM" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_BASEDRUM.value());
			}
			case "NOTE_SNARE_DRUM", "BLOCK_NOTE_SNARE", "BLOCK_NOTE_BLOCK_SNARE" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_SNARE.value());
			}
			case "NOTE_STICKS", "BLOCK_NOTE_HAT", "BLOCK_NOTE_BLOCK_HAT" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_HAT.value());
			}
			case "NOTE_BASS_GUITAR", "BLOCK_NOTE_GUITAR", "BLOCK_NOTE_BLOCK_GUITAR" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_GUITAR.value());
			}
			case "NOTE_FLUTE", "BLOCK_NOTE_FLUTE", "BLOCK_NOTE_BLOCK_FLUTE" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_FLUTE.value());
			}
			case "NOTE_BELL", "BLOCK_NOTE_BELL", "BLOCK_NOTE_BLOCK_BELL" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_BELL.value());
			}
			case "NOTE_XYLOPHONE", "BLOCK_NOTE_XYLOPHONE", "BLOCK_NOTE_BLOCK_XYLOPHONE" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_XYLOPHONE.value());
			}
			case "NOTE_PLING", "BLOCK_NOTE_PLING", "BLOCK_NOTE_BLOCK_PLING" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_PLING.value());
			}
			case "BLOCK_NOTE_BLOCK_IRON_XYLOPHONE" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_IRON_XYLOPHONE.value());
			}
			case "BLOCK_NOTE_BLOCK_COW_BELL" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_COW_BELL.value());
			}
			case "BLOCK_NOTE_BLOCK_DIDGERIDOO" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_DIDGERIDOO.value());
			}
			case "BLOCK_NOTE_BLOCK_BIT" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_BIT.value());
			}
			case "BLOCK_NOTE_BLOCK_BANJO" -> {
				return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_BANJO.value());
			}
		}
		return bullshit(SoundEvents.BLOCK_NOTE_BLOCK_BASS.value());
	}

	private SoundEvent bullshit(SoundEvent soundEvent) {
		return soundEvent;
	}
